...
export declare const useApiContract: ({ functionName, address, abi, chain, params }: ApiContractParams, options?: UseMoralisWeb3ApiCallOptions) => {
    runContractFunction: ({ throwOnError, onComplete, onError, onSuccess, params: fetchParams, }?: import("../../internal/_useResolveAsyncCall").ResolveCallOptions<(string & import("moralis-v1/types/generated/web3Api").defaultResponse<string>) | null, {
        ...
        address: string;
    }>) => Promise<(string & import("moralis-v1/types/generated/web3Api").defaultResponse<string>) | null | undefined>;
    data: (string & import("moralis-v1/types/generated/web3Api").defaultResponse<string>) | null;
    error: Error | null;
    isLoading: boolean;
    isFetching: boolean;
};
